...
var IndexedDbKeyStore = (function () {
    function IndexedDbKeyStore(dbName, storeName) {
        var _this = this;
        if (dbName === void 0) { dbName = 'blindnet'; }
...
var Blindnet = (function () {
    ...
    Blindnet.testBrowser = function () {
        return __awaiter(this, void 0, void 0, function () {
            var aesKeyP, aesKey, rsaKeyPair, eccKeyPair, keyStore, key, keys, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 10, , 11]);
                        aesKeyP = generateRandomAESKey();
                    ...
                    case 3:
                        eccKeyPair = _a.sent();
                        keyStore = new IndexedDbKeyStore('blindnet_test');
...
export { Blindnet, error, helper as util };
